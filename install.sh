...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
  ...
  curl -LO https://github.com/webbrandon/cluster-cost/releases/download/${VERSION}/debian
  ...
  curl -LO https://github.com/webbrandon/cluster-cost/releases/download/${VERSION}/darwin
  echo "Installing cluster-cost ${VERSION}"
  chmod +x darwin
  ...
  curl -LO https://github.com/webbrandon/cluster-cost/archive/${VERSION}.tar.gz
